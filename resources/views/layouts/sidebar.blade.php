                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li class="menu-title">Visitor Management</li>
                            <li class="">
                                <a href="{{ route('visitor.checkin') }}" class="waves-effect {{ request()->is('visitor-checkin') ? 'mm active' : '' }}">
                                    <i class="dripicons-user-group"></i> <span> Visitor Check-In </span>
                                </a>
                            </li>
                            <li class="">
    <a href="{{ url('/visitor-logs') }}" class="waves-effect {{ request()->is('visitor-logs') ? 'mm active' : '' }}">
        <i class="dripicons-to-do"></i> <span> Visitor Logs </span>
    </a>
</li>
                        </ul>         
